namespace MovieAPI.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.People", "Movie_Id2", "dbo.Movies");
            DropForeignKey("dbo.MovieGenres", "Genre_Id", "dbo.Genres");
            DropForeignKey("dbo.MovieGenres", "Movie_Id", "dbo.Movies");
            DropForeignKey("dbo.People", "Movie_Id1", "dbo.Movies");
            DropForeignKey("dbo.People", "Movie_Id", "dbo.Movies");
            DropForeignKey("dbo.Movies", "Person_Id2", "dbo.People");
            DropForeignKey("dbo.Movies", "Person_Id1", "dbo.People");
            ...
            DropIndex("dbo.People", new[] { "Movie_Id2" });
            DropIndex("dbo.People", new[] { "Movie_Id1" });
            DropIndex("dbo.People", new[] { "Movie_Id" });
            DropIndex("dbo.Movies", new[] { "Person_Id2" });
            DropIndex("dbo.Movies", new[] { "Person_Id1" });
